...
contract StarNotary is ERC721 {
    ...
    /**
     * @dev Sets the values for `name` and `symbol`. All of these
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOfToken1 == msg.sender || ownerOfToken2 == msg.sender, "You can exhcange the star you don't owned.");
